  ...
  <div id="app">
    ...
    <section id="main-slider">
      <div class="owl-carousel main-slider1">
        <div class="item" style="background-image: url(/static/images/bg1.jpg);">
        ...
        <!--/.item-->
        <div class="item" style="background-image: url(/static/images/bg2.jpg);">
          <div class="slider-inner">
            <div class="container">
              <div class="row">
                <div class="col-sm-12 text-center">
        ...
        <div class="portfolio-items">
          <div class="portfolio-item creative">
            <div class="portfolio-item-inner">
              <img class="img-responsive" src="../../assets/images/work_1.jpg" alt="">
          ...
          <div class="portfolio-item corporate portfolio">
            <div class="portfolio-item-inner">
              <img class="img-responsive" src="../../assets/images/work_2.jpg" alt="">
              <div class="portfolio-info">
          ...
          <div class="portfolio-item creative">
            <div class="portfolio-item-inner">
              <img class="img-responsive" src="../../assets/images/work_3.jpg" alt="">
              <div class="portfolio-info">
          ...
          <div class="portfolio-item corporate">
            <div class="portfolio-item-inner">
              <img class="img-responsive" src="../../assets/images/work_4.jpg" alt="">
              <div class="portfolio-info">
          ...
          <div class="portfolio-item creative portfolio">
            <div class="portfolio-item-inner">
              <img class="img-responsive" src="../../assets/images/work_5.jpg" alt="">
              <div class="portfolio-info">
          ...
          <div class="portfolio-item corporate">
            <div class="portfolio-item-inner">
              <img class="img-responsive" src="../../assets/images/work_6.jpg" alt="">
              <div class="portfolio-info">
                <h3>Portfolio Item 5</h3>
                Lorem Ipsum Dolor Sit
          ...
          <div class="portfolio-item creative portfolio">
            <div class="portfolio-item-inner">
              <img class="img-responsive" src="../../assets/images/work_7.jpg" alt="">
              <div class="portfolio-info">
          ...
          <div class="portfolio-item corporate">
            <div class="portfolio-item-inner">
              <img class="img-responsive" src="../../assets/images/work_8.jpg" alt="">
              <div class="portfolio-info">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-3">
            <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
              <div class="team-img">
                <img src="../../assets/images/team_4.jpg" alt="">
              </div>
              <div class="team-info">
                <h3>Nasir uddin</h3>
                <span>UI/UX</span>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6">
            <div class="panel-one">
              <div class="user-img">
                <img alt="" src="../../assets/images/testimonail_1.jpg">
              </div>
          ...
          <div class="col-sm-6">
            <div class="panel-one">
              <div class="user-img">
                <img alt="" src="../../assets/images/testimonail_2.jpg">
              </div>
              <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
          ...
          <div class="col-sm-6">
            <div class="panel-one">
              <div class="user-img">
                <img alt="" src="../../assets/images/testimonail_3.jpg">
              </div>
              <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
          ...
          <div class="col-sm-6">
            <div class="panel-one">
              <div class="user-img">
                <img alt="" src="../../assets/images/testimonail_4.jpg">
              </div>
              <div class="testi-info">
                <h4>Jonathon Andrew</h4>
                <h5>Lorem ipsum dolor sit amet</h5>
