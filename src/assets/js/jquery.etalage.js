...
(function (global, factory) {
  ...
  $.fn.etalage = function (options) {
    ...
    var o = $.extend(
      {
        ...
        click_callback: function () {
          // Provide your own callback for the click event (function). Takes 2 arguments: image_anchor, instance_id
          return true
        },
        change_callback: function () {
          // Provide your own callback for the change event (thumb switching) (function). Takes 2 arguments: image_anchor, instance_id
          return true
        }
      },
      options
    ...
    $.each(this, function () {
      ...
      if (
        $container.is('ul') &&
        $container.children('li').length &&
        $container.find('img.etalage_source_image').length
      ) {
        var i,
          j,
          src,
          ...
          autotimer,
          description,
          container_outerwidth,
          smallthumbs_overflow,
          css,
        ...
        if (
          o.smallthumbs_position === 'left' ||
          o.smallthumbs_position === 'right'
        ) {
        ...
        $.each($thumbs, function (i) {
          ...
          if ($t_anchor.length) {
            $t
              .find('.etalage_thumb_image')
              .data('anchor', $t_anchor.attr('href'))
          }
        })
        var $thumb_images = $thumbs
          .find('.etalage_thumb_image')
          .css({
        ...
        // Add zoom icon
        var $icon = $('<li class="etalage_icon">&nbsp;</li>').appendTo(
          $container
        )
        if (o.show_icon) {
          $icon.show()
        ...
        var $zoom_img_area = $zoom.children('div'),
          $zoom_preview
        if (preview) {
          $zoom_preview = $('<img class="etalage_zoom_preview" />')
            .css({
              width: o.source_image_width,
              height: o.source_image_height,
              opacity: 0.3
            })
            .prependTo($zoom_img_area)
            .show()
        }
        ...
        if (images > 1 || !o.smallthumb_hide_single) {
          ...
          if (images > small_thumbs) {
            ...
            if (o.show_begin_end_smallthumb) {
              ...
              $(
                '<li class="etalage_smallthumb_first etalage_smallthumb_navtoend"><img class="etalage_small_thumb" src="' +
                  src +
                  '" /></li>'
              )
                .data('src', src)
              ...
              $(
                '<li class="etalage_smallthumb_navtostart"><img class="etalage_small_thumb" src="' +
                  src +
                  '" /></li>'
              )
                .data('src', src)
        ...
        var thumb_border =
            parseInt($thumbs.css('borderLeftWidth'), 10) +
            parseInt($thumbs.css('borderRightWidth'), 10) +
            parseInt($thumb_images.css('borderLeftWidth'), 10) +
            parseInt($thumb_images.css('borderRightWidth'), 10),
          thumb_margin =
            parseInt($thumbs.css('marginLeft'), 10) +
            parseInt($thumbs.css('marginRight'), 10),
          thumb_padding =
            parseInt($thumbs.css('paddingLeft'), 10) +
            parseInt($thumbs.css('paddingRight'), 10) +
            parseInt($thumb_images.css('marginLeft'), 10) +
            parseInt($thumb_images.css('marginRight'), 10) +
            parseInt($thumb_images.css('paddingLeft'), 10) +
            parseInt($thumb_images.css('paddingRight'), 10),
          thumb_outerwidth =
            o.thumb_image_width + thumb_border + thumb_margin + thumb_padding,
          thumb_outerheight =
            o.thumb_image_height + thumb_border + thumb_margin + thumb_padding,
          smallthumb_border = 0,
          smallthumb_margin = 0,
        ...
        if (images > 1 || !o.smallthumb_hide_single) {
          smallthumb_border =
            parseInt($smallthumb.css('borderLeftWidth'), 10) +
            parseInt($smallthumb.css('borderRightWidth'), 10) +
            parseInt($smallthumb_images.css('borderLeftWidth'), 10) +
            parseInt($smallthumb_images.css('borderRightWidth'), 10)
          smallthumb_margin = parseInt($smallthumb.css('marginTop'), 10)
          smallthumb_padding =
            parseInt($smallthumb.css('paddingLeft'), 10) +
            parseInt($smallthumb.css('paddingRight'), 10) +
            parseInt($smallthumb_images.css('marginLeft'), 10) +
            parseInt($smallthumb_images.css('marginRight'), 10) +
            parseInt($smallthumb_images.css('paddingLeft'), 10) +
            parseInt($smallthumb_images.css('paddingRight'), 10)
          if (smallthumbs_align === 'vert') {
            smallthumb_height =
              Math.round(
                (thumb_outerheight - (small_thumbs - 1) * smallthumb_margin) /
                  small_thumbs
              ) -
              (smallthumb_border + smallthumb_padding)
            smallthumb_width = Math.round(
              o.thumb_image_width * smallthumb_height / o.thumb_image_height
            )
            smallthumb_outerwidth =
              smallthumb_width + smallthumb_border + smallthumb_padding
            smallthumb_outerheight =
              smallthumb_height + smallthumb_border + smallthumb_padding
          } else {
            smallthumb_width =
              Math.round(
                (thumb_outerwidth - (small_thumbs - 1) * smallthumb_margin) /
                  small_thumbs
              ) -
              (smallthumb_border + smallthumb_padding)
            smallthumb_height = Math.round(
              o.thumb_image_height * smallthumb_width / o.thumb_image_width
            )
            smallthumb_outerwidth =
              smallthumb_width + smallthumb_border + smallthumb_padding
            smallthumb_outerheight =
        ...
        if (
          o.zoom_area_width - zoom_border * 2 - zoom_padding * 2 >
          o.source_image_width
        ) {
        ...
        if (o.zoom_area_height === 'justify') {
          ...
          zoom_area_height =
            o.zoom_area_height - zoom_border * 2 - zoom_padding * 2
        }
        ...
        if (o.show_descriptions) {
          description_border =
            parseInt($description.css('borderLeftWidth'), 10) +
            parseInt($description.css('borderRightWidth'), 10)
          description_margin =
            parseInt($description.css('marginLeft'), 10) +
            parseInt($description.css('marginRight'), 10)
          description_padding =
            parseInt($description.css('paddingLeft'), 10) +
            parseInt($description.css('paddingRight'), 10)
          description_width =
            zoom_area_width -
            description_border -
            description_margin -
        ...
        var magnifier_border = parseInt($magnifier.css('borderTopWidth'), 10),
          magnifier_top =
            parseInt($thumbs.css('borderTopWidth'), 10) +
            ...
            magnifier_border,
          magnifier_left =
            $thumb_images.offset().left -
            $container.offset().left -
            magnifier_border
        if (o.smallthumbs_position === 'left') {
          magnifier_left =
            magnifier_left + smallthumb_outerwidth + smallthumb_margin
        } else if (o.smallthumbs_position === 'top') {
          magnifier_top =
            magnifier_top + smallthumb_outerheight + smallthumb_margin
        }
        var magnifier_width = Math.round(
            zoom_area_width * (o.thumb_image_width / o.source_image_width)
          ),
          magnifier_height = Math.round(
            zoom_area_height * (o.thumb_image_height / o.source_image_height)
          ),
          magnifier_bottom =
            magnifier_top + o.thumb_image_height - magnifier_height,
          magnifier_right =
            magnifier_left + o.thumb_image_width - magnifier_width,
        ...
        if (o.show_hint) {
          hint_top =
            parseInt(o.hint_offset, 10) + parseInt($hint.css('marginTop'), 10)
          hint_right =
            parseInt(o.hint_offset, 10) + parseInt($hint.css('marginRight'), 10)
        ...
        if (smallthumbs_align === 'vert') {
          container_outerwidth =
            thumb_outerwidth + smallthumb_margin + smallthumb_outerwidth
          $container.css({
          ...
          $container.css({
            width: container_outerwidth,
            height:
              thumb_outerheight + smallthumb_margin + smallthumb_outerheight
          })
        }
        // Icon
        if (o.show_icon) {
          css = {
            top:
              thumb_outerheight -
              $icon.outerHeight(true) -
              parseInt(o.icon_offset, 10),
        ...
        if (images > 1 || !o.smallthumb_hide_single) {
          if (smallthumbs_align === 'vert') {
            ...
            $smallthumbs_ul.css({
              height:
                smallthumb_outerheight * smallthumbs +
                smallthumbs * smallthumb_margin +
                100
            }) // 100 = some extra to prevent a browser zoom glitch fix
            $smallthumb_images
              .css({
            ...
            $smallthumbs_ul.css({
              width:
                smallthumb_outerwidth * smallthumbs +
                smallthumbs * smallthumb_margin +
                100
            }) // 100 = some extra to prevent a browser zoom glitch fix
            $smallthumb_images
          ...
          if (smallthumbs_align === 'vert') {
            smallthumbs_overflow =
              smallthumb_outerheight * small_thumbs +
              (small_thumbs - 1) * smallthumb_margin -
              thumb_outerheight
          } else {
            smallthumbs_overflow =
              smallthumb_outerwidth * small_thumbs +
              (small_thumbs - 1) * smallthumb_margin -
              thumb_outerwidth
          }
        ...
        if (o.show_icon && !o.magnifier_invert) {
          $magnifier.css({
            background:
              $magnifier.css('background-color') +
              ' ' +
        ...
        var st_click = function ($next_active, moved) {
          ...
          $next_thumb = $thumbs
            .filter('.thumb_' + $next_active.data('thumb_id'))
            .addClass('etalage_thumb_active')
            .show()
            .stop()
            .css({
        ...
        $thumbs
          ...
          .mousemove(function (e) {
            var mouse_x = Math.round(
                e.pageX - $current_thumb.offset().left + magnifier_left
              ),
              mouse_y = Math.round(
                e.pageY - $current_thumb.offset().top + magnifier_top
              )
            ...
            new_zoomx = -(
              (new_x - magnifier_left) *
              (1 / (o.thumb_image_width / o.source_image_width))
            )
            new_zoomy = -(
              (new_y - magnifier_top) *
              (1 / (o.thumb_image_height / o.source_image_height))
            )
        ...
        function st_shift_1 (direction) {
          ...
          st_moving = true
          var $first = $container
            .find('.etalage_smallthumb_first')
            .removeClass('etalage_smallthumb_first')
          var $last = $container
            .find('.etalage_smallthumb_last')
          ...
          if (st_steps) {
            ...
            distance =
              smallthumbs_align === 'vert'
                ? $next_first.position().top
                : $next_first.position().left
        ...
        function st_slide_to_startend (to) {
          ...
          if (to === 'end') {
            $next_first = $smallthumb
              .eq(smallthumbs - small_thumbs)
              .addClass('etalage_smallthumb_first')
            $next_last = $smallthumb
              .eq(smallthumbs - 1)
        ...
        if (images > 1 || !o.smallthumb_hide_single) {
          ...
          $smallthumb.click(function () {
            ...
            if (
              !$this.hasClass('etalage_smallthumb_active') &&
              (!st_moving || st_steps)
            ) {
              // Slide left / up
              if (
                $this.hasClass('etalage_smallthumb_first') &&
                $this.prev().length
              ) {
                st_shift_1('left')
                ...
                $this.hasClass('etalage_smallthumb_last') &&
                $this.next().length
              ) {
                // Slide right / down
                st_shift_1('right')
